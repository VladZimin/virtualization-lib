...
const validateProps = (props: UseDynamicSizeListProps ) => {
  const {estimateItemHeight, itemHeight} = props
  if (!estimateItemHeight && !itemHeight) {
...
function useDynamicSizeList(props: UseDynamicSizeListProps ) {
  ...
  }, [scrollTop, listHeight, itemHeight, itemsCount, estimateItemHeight, measurementCache, overscan, getItemKey])
